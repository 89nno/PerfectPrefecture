...
const quizs = new Array(
  ...
  ['関門（かんもん）海峡で九州地方と中国地方が隣り合っていますが、その都道府県の正しい組み合わせは？','福岡県と山口県','岡山県と香川県','北海道と青森県',1,'岡山県と香川県は瀬戸大橋、北海道と青森県は津軽海峡（あるいは青函トンネル）があります。'],
  ['仙台市にある球場は次のうちどれ？','明治神宮球場','楽天生命パーク宮城','ZOZOマリンスタジアム',2,'明治神宮球場は東京都、ZOZOマリンスタジアムは千葉県にあります。'],
  ['岐阜県のマスコットキャラクター「うーたん」は何の鳥？','白鳥','大鷲','鵜',3,'岐阜県には1,300年以上の長きにわたる鵜飼（うかい）の伝統があります。'],
  ...
  ['阿蘇山や、滝を裏側から見られるという鍋ケ滝公園、イルカウォッチングと言えば何県？','熊本県','茨城県','宮城県',1,'県を代表するキャラクターくまモンのおひざもとでもあります。'],
  ...
  ['次のうち国内の活火山で鹿児島県にある山は？','十勝岳','桜島','御嶽山',2,'十勝岳は北海道、御嶽山は中部地方にある活火山です。'],
  ...
  ['京都府にある、10円玉のデザインにもなっている寺院はどれ？','不動院','平等院鳳凰堂','中善寺',2,'10円玉に酸っぱい系の調味料を塗ってきれいにすると、ほんの少しゴージャスな気分になれます。'],
